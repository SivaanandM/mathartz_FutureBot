...
public class FormulaAmazeF3 {
	...
	double ltp, points,fd,nextline,baseline,tpl;
	Date ltt;
	...
	public void UpdateVariables()
	{
		try
		{
			fvalue.SetAmazevalues(c, lc, r, points, fd, nextline, baseline, way,tpl);
	...
	public void AssignvVariables()
	{
		try
		{
			...
			fvalue = listcom.getAmazeValuesFDByID(identity, CommonObjects.GlobalAmazeValuesF3);
			c = fvalue.getc();
			lc = fvalue.getlc();
			r = fvalue.getr();
