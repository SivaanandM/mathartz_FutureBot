...
public class FormulaAmazeZCallF1 {
	...
	public void UpdateVariables()
	{
		try
		{
			...
			if ((way.equalsIgnoreCase("L4"))||(way.equalsIgnoreCase("L3"))||(way.equalsIgnoreCase("L2"))||(way.equalsIgnoreCase("R3"))||(way.equalsIgnoreCase("R2")))
			{
				if ((way.equalsIgnoreCase("L4")) && (isend))
				{
					bv.setF1PL(tpl);
				}
				else
	...
	public void AssignvVariables()
	{
		try
		{
			...
			fvalue = listcom.getAmazeValuesZByID(identity, CommonObjects.GlobalAmazeValuesF1);
			c = fvalue.getc();
			lc = fvalue.getlc();
			r = fvalue.getr();
