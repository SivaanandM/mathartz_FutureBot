...
public class FeedAPITesterWithQueue implements FeedService {
	...
	public void feedrequest() {
		...
		executor.start(this);
		executor.subscribe(CommonObjects.HeadID, CommonObjects.HeadSymbol);
		System.out.println("Subscribed : "+ CommonObjects.HeadID +" , "+ CommonObjects.HeadSymbol);
...
//				System.out.println("Subscribed : "+ headid[0] +" , "+ headid[1]);
//			}
//		}
