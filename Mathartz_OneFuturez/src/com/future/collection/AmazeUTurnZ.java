...
public class AmazeUTurnZ {
	...
	public AmazeUTurnZ(int id, String headsecid, int c, int lc, int r, double points, double low, double high, double nextline, double baseline, String way, double tpl, double spoint, double z)
	{
		this.id = id;
	...
	public void SetAmazeUTurnZ(int c, int lc, int r, double points, double low, double high, double nextline, double baseline, String way, double tpl, double spoint, double z)
	{
		this.C = c;
		this.LC = lc;
		this.R = r;
