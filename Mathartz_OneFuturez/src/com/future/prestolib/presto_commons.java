...
public class presto_commons {
	...
	static String FutSegment = "FO", optSegment = "OPT", EquSegment = "CM";
	...
	public List<Scriptsdetail> get_fut_opt_Scripts(String strSymbol, String strexpMMMDD)
	{
		...
		try
		{
			...
			checkandLoginFinvasia();
			Scriptsdetail sc;
			SYMBOLDETAIL = get_CM_FUT_Details("NSEFO", strSymbol, FutSegment, FutIdxInsttype);
			if (SYMBOLDETAIL != null)
			{
